...
#Lot 1
coil_lot1 <- subset(suspension_coil_data, Manufacturing_Lot=="Lot1")
t.test(coil_lot1$PSI,mu=1500)

#Lot 2
coil_lot2 <- subset(suspension_coil_data, Manufacturing_Lot=="Lot2")
t.test(coil_lot2$PSI,mu=1500)

#Lot 3
coil_lot3 <- subset(suspension_coil_data, Manufacturing_Lot=="Lot3")
